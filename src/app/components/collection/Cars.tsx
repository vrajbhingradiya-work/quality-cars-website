...
function Cars() {
  ...
  return (
    <div className={` flex flex-col justify-center items-center`}>
      ...
      >
        <div className="p-8 lg:px-16 md:py-16 flex flex-col justify-center  md:grid md:grid-cols-2  xl:grid-cols-3 gap-8 items-center">
          {cars?.slice(0, totalResults).map((car, index) => (
            <SimpleFadeIn sequence={index * 5} key={index}>
