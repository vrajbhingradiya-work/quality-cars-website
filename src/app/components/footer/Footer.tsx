...
const footerCategoryLinks = {
  ...
  brands: {
    category: "BRANDS",
    links: [
      { title: "Aprilia", href: "/collection" },
      { title: "Aston Martin", href: "/collection" },
      { title: "Audi", href: "/collection" },
      { title: "Avanturaa Choppers", href: "/collection" },
      { title: "Bentley", href: "/collection" },
      { title: "BMW", href: "/collection" },
      { title: "Buick", href: "/collection" },
      { title: "Cadillac", href: "/collection" },
      { title: "Chevrolet", href: "/collection" },
      { title: "Chrysler", href: "/collection" },
      { title: "Citroen", href: "/collection" },
      { title: "DC", href: "/collection" },
      { title: "Ducati", href: "/collection" },
      { title: "Ferrari", href: "/collection" },
      { title: "Fiat", href: "/collection" },
      { title: "Ford", href: "/collection" },
      { title: "Harley Davidson", href: "/collection" },
      { title: "Honda", href: "/collection" },
      { title: "Hummer", href: "/collection" },
      { title: "Hyundai", href: "/collection" },
      { title: "Indian", href: "/collection" },
      { title: "Infinity", href: "/collection" },
      { title: "Jaguar", href: "/collection" },
      { title: "Jeep", href: "/collection" },
      { title: "Kawasaki", href: "/collection" },
      { title: "KIA", href: "/collection" },
      { title: "KTM", href: "/collection" },
      { title: "Lamborghini", href: "/collection" },
      { title: "Land Rover", href: "/collection" },
      { title: "Lexus", href: "/collection" },
      { title: "Maserati", href: "/collection" },
      { title: "Maybach", href: "/collection" },
      { title: "McLaren", href: "/collection" },
      { title: "Mercedes-Benz", href: "/collection" },
      { title: "Mini", href: "/collection" },
      { title: "MV Agusta", href: "/collection" },
      { title: "Nissan", href: "/collection" },
      { title: "Porsche", href: "/collection" },
      { title: "Rolls-Royce", href: "/collection" },
      { title: "Royal Enfield", href: "/collection" },
      { title: "Skoda", href: "/collection" },
      { title: "Suzuki", href: "/collection" },
      { title: "Tesla", href: "/collection" },
      { title: "Toyota", href: "/collection" },
      { title: "Triumph", href: "/collection" },
      { title: "Volkswagen", href: "/collection" },
