...
function IntroQualityCars() {
  return (
    <div
      className="MD
  p-8 md:p-32 grid grid-cols-1 gap-16 text-black/70 tracking-wider text-xl py-28"
    >
      <div className="flex flex-col gap-6  ">
        <span className="text-3xl font-semibold">
          Quality Cars, a pre-owned luxury car dealer deals with 24 brands
        </span>
        <p>
          Quality Cars started in 2009 as a benchmark model for the Pre-Used, or
...
export default IntroQualityCars;
