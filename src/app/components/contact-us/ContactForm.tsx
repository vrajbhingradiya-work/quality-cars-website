...
function ContactForm() {
  ...
  return (
    <div className="pt-16 w-full  flex justify-center items-center p-8 ">
      <form
        onSubmit={handleSubmit}
        className=" min-w-full md:min-w-[70%] xl:min-w-[600px]  md:max-w-[700px] p-4 md:p-8 grid grid-cols-1 gap-4 bg-white rounded-xl  "
      >
